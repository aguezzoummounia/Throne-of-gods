...
import PowerCard from "./characters/powers/power-card";
...
export default function ConnectedCardsCustomAnchors({
  ...
  return (
    <div
      ref={containerRef}
      className="relative md:min-h-[120vh] min-h-[1500px] w-full text-bronze"
    >
      {powers.map((power, index) => {
        ...
        return (
          <div
            ...
            className={`${position.item} absolute md:w-[250px] w-[230px] aspect-[2/3] bg-red-950`}
          >
            <PowerCard
              name={power.name}
              image={power.image}
